...
func Root() *cobra.Command {
	...
	root.AddCommand(loginCmd(), logoutCmd(), statusCmd(), doctorCmd(), configCmd(), orgCmd(), upgradeCmd(), initCmd(), sessionsCmd(), phonesCmd(), phoneCmd(), workflowsCmd(), runsCmd(), apiKeysCmd())
